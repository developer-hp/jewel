...
<div class="card">
    ...
    <div class="card-body">
        <div class="row g-3">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        <div class="row g-2">
                            ...
                            <div class="col-6">
                                <input type="text" name="contact_no_alt"
                                    class="form-control @error('contact_no_alt') is-invalid @enderror"
                                    value="{{ old('contact_no_alt', $form->contact_no_alt) }}" maxlength="30"
                                    placeholder="Alternate">
                                @error('contact_no_alt')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        </div>
            ...
            <div class="col-md-6">
                <div class="row">
                    <label for="sales_person_ids" class="col-sm-4 col-form-label text-sm-end">
                    ...
                    <div class="col-sm-8">
                        ...
                        <small class="text-muted">
                            One or more. The names are kept on the form, so a later rename in the
                            master will not change what has already printed.
                        </small>
            ...
            <div class="col-md-6">
                <div class="row">
                    <label for="approx_extra_charge" class="col-sm-4 col-form-label text-sm-end">
                        Approx Extra Charge
                    </label>
                    <div class="col-sm-8">
